...
<body class="bg-light" style=" min-height: 100%;margin-bottom: -60px;">
  ...
  <div class="container-fluid ">
    <div class="container-fluid my-5 ">
      <div class="row">
        ...
        <div class="col-md-5 ms-5">
          <div>
            <h1 class="fw-bold fst-italic my-3">Activités</h1>
          </div>
    ...
    <div class="container-fluid my-5 ">
      <div class="row">
        ...
        <div class="col-md-4">
          <h2 class="fw-bold fst-italic my-4">Hangout</h2>
    ...
    <div class="container-fluid my-5 bg-dark ">
      <div class="row">
        <div class="col-md-6">
          <img src="image/groupe.jpg" alt="" class="img-fluid rounded">
        </div>
        <div class="col-md-6 ">
          <div class="fst-italic fs-6 my-5 text-light fw-light ms-5">
            <h1 class="fw-bold fst-italic mb-5">YouthDays</h1>
    ...
    <div class="container my-5">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="fw-bold fst-italic mb-5">Inscription à la Newsletter</h1>
    ...
    <footer class=" footer bg-dark text-light my-5 " style=" height: 100%; width: 100%;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-2"></div>
          <div class="col-md-2">
            <p class="fs-4 mt-4"> <a class="nav-link" href="#"> Opportunités </a></p>
            <p class="fs-4"> <a class="nav-link" href="#"> Activités </a></p>
          </div>
          <div class="col-md-2">
            <p class="fs-4 mt-4"> <a class="nav-link" href="#"> Actualités </a></p>
            <p class="fs-4"> <a class="nav-link" href="#"> Forum </a></p>
          ...
          <div class="col-md-2">
            ...
            <p> <a class="nav-link" href="#"> Emission Tv </a></p>
          </div>
